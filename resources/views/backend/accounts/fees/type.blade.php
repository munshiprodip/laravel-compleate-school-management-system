    ...
    <div class="col-12">
        ...
        <div class="card card-dark">
            <div class="card-header">
                ...
                <h3 class="card-title"><span><a onclick="addData()" href="#" class="btn btn-outline-info">ADD </button></a></span> Fees Type</h3>
    ...
    <script type="text/javascript">
        ...
        function changeStatus(id){
            swal.fire({
                ...
                if (e.value === true){
                    var url = "{{url('feestypes/status/change')}}"+'/'+id;
                    $.ajax({
                        url:url,
                        type:"GET",
                        dataType:"JSON",
