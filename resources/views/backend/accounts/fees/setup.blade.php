    ...
    <div class="col-12">
        ...
        <div class="card card-dark">
            <div class="card-header">
                ...
                <h3 class="card-title"><span><a onclick="addData()" href="#" class="btn btn-outline-info">ADD </button></a></span> Fees Setup</h3>
                ...
                <form method="POST" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" class="form-control" required placeholder="Name" >
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                <form method="POST" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="gender_id">Description *</label>
                            <input type="text" id="description" name="description" class="form-control" required placeholder="Name" >
                        </div>
                        <div class="form-group">
                            <label for="gender_id">End Date *</label>
                            <input type="text" id="end_date" name="end_date" class="form-control" required placeholder="Description" >
...
@section('script')
    <script type="text/javascript">
        ...
        $(function () {
            $('#editForm form').on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    var id = $('#id').val();
                    $.ajax({
                        url: "{{url('feessetup')}}"+'/'+id,
                        type: "POST",
        ...
        function changeStatus(id){
            swal.fire({
                ...
                if (e.value === true){
                    var url = "{{url('feessetup/status/change')}}"+'/'+id;
                    $.ajax({
                        url:url,
                        type:"GET",
                        dataType:"JSON",
