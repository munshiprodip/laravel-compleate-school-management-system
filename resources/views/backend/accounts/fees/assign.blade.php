...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Assign Fees</li>
@endsection
        ...
        <form id="promoteStudent" method="POST">
            ...
            <div class="card card-dark">
                <div class="card-header">
                    ...
                    <input class="btn btn-primary float-right" id="submit_btn" type="submit" value="Assign">
                </div>
                <div class="card-body">
        ...
        $('#sectionOption').on('change', function () {
            ...
            if (class_id!=="" && class_id){
                ...
                table =    $("#studentTable").DataTable({
                    ...
                    ordering: false,
                    lengthChange: false,
                    ajax: "{{url('/student/api')}}"+'/'+class_id+'/'+section_id+'/'+'{{$fees_id}}',
                    columns: [
        ...
        $(function () {
            $('#promoteStudent').on('submit', function (e) {
                if (!e.isDefaultPrevented()){
                    ...
                    $.ajax({
                        url: "{{route('assignFeesSubmit', $fees_id)}}",
                        type: "POST",
                        data: {'_token': csrf_token, 'student_id': student_id},
                        success:function (data) {
